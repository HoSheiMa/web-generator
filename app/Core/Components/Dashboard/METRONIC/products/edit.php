...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $pdo->prepare('UPDATE products SET name = ?, description = ?, price = ?, brand = ?, image = ? WHERE id = ?');
        $stmt->execute([$name, $description, $price, $brand, $image, $id]);
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form method="post" action="edit.php" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" name="brand" id="brand" class="form-control" value="<?= htmlspecialchars($product['brand']) ?>" required>
                                                        </div>
                                                        <div class="form-group mb-3">
                                                            <label for="image" class="form-label">Image</label>
                                                            <input type="file" name="image" id="image" class="form-control">
                                                            <img src="<?= htmlspecialchars($product['image']) ?>" alt="Current Image" class="img-thumbnail mt-3" style="max-width: 100px;">
                                                        </div>
