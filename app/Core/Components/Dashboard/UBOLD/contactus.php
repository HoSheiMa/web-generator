...
// SQL query to fetch emails with LIMIT and OFFSET
$limit = 10; // Number of records to fetch
$offset = isset($_GET['offset']) ? (int) $_GET['offset'] : 0; // Starting point


$sql = "SELECT * FROM mails LIMIT :limit OFFSET :offset";
...
$total_mails = $countStmt->fetchColumn();
$pagination_html = "";
$n = 1;
do {
    $pagination_html .= ' <li class="page-item active"><a href="?offset=' . ($n - 1) * 10 . '" class="page-link">' . $n . '</a></li>';
    $n++;
    $total_mails -= 10;
} while ($total_mails > 0);
...
foreach ($mails as $mail) {
    $mails_html .= '<div class="d-flex mb-10">
            <!--begin::Symbol-->
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center mb-2">
                    <!--begin::Title-->
                    <a href="apps/support-center/tickets/view.html" class="text-gray-900 text-hover-primary fs-4 me-3 fw-semibold">' . $mail['name'] . '</a>
                    <!--end::Title-->
                    <!--begin::Label-->
                    <span class="badge badge-light my-1">' . $mail['email'] . '</span>
                    <!--end::Label-->
                </div>
                <!--end::Content-->
                <!--begin::Text-->
                                        ...
                                        <div class="d-flex flex-column flex-xl-row p-7">
                                            ...
                                            <div class="flex-lg-row-fluid me-xl-15 mb-20 mb-xl-0">
                                                ...
                                                <div class="mb-0">
                                                    <!--end::Search form-->
                                                    <!--begin::Heading-->
                                                    <h1 class="text-gray-900 mb-10">Mails</h1>
                                                    <!--end::Heading-->
                                                    <!--begin::Tickets List-->
                                                    <div class="mb-10">
                                                        <!--begin::Ticket-->
