                                                        ...
                                                        <tbody>
                                                            <?php foreach ($users as $user) : ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="edit.php?id=<?= $user['id'] ?>" class="btn btn-icon btn-light-primary">
                                                                            <i class="ki-duotone ki-pencil fs-1">
                                                                                <span class="path1"></span>
                                                                                <span class="path2"></span>
                                                                            </i>
                                                                        </a>
                                                                        <a href="index.php?delete=<?= $user['id'] ?>" class="btn btn-icon btn-light-danger" onclick="return confirm('Are you sure you want to delete this user?');">
