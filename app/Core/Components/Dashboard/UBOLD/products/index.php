                                    ...
                                    <div class="col-12">
                                        <div class="card m-5">
                                            <div class="card-body">
                                                ...
                                                <a href="create.php" class="btn btn-success mb-3">Create Product</a>
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($products as $product) : ?>
                                                                <tr>
                                                                    ...
                                                                    <td><img src="<?= htmlspecialchars($product['image']) ?>" alt="Product Image" class="img-thumbnail" style="max-width: 100px;"></td>
                                                                    <td><?= htmlspecialchars($product['ordered_count']) ?></td>
                                                                    <td><?= htmlspecialchars($product['created_at']) ?></td>
                                                                    <td>
                                                                        <a href="edit.php?id=<?= $product['id'] ?>" class="btn btn-icon btn-light-primary">
