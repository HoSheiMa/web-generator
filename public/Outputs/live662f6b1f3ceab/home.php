  ...
  <body>
    ...
    "navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark">
      <div class="container-fluid">
        ...
        "/home.php"><span class="text-white">tree.com</span></a>
    ...
    "background: url(/storage/images/qWN09X6bYsKW4sH8AEHeH8RvDdf2fYng7s11i67Y.jpg);background-size:cover;"
    id="home">
            ...
            <div class="row align-items-center">
              ...
              "col-xl-4 offset-xl-2 col-lg-5 offset-lg-1 col-md-7">
                <div class="home-img position-relative">
                  <img src="./storage/pexels-photo-8294158.jpeg"
                  alt="" class="home-first-img"> <img src=
                  "./storage/pexels-photo-7611741.jpeg" alt=""
                  class="home-second-img mx-auto d-block">
                  <img src="./storage/pexels-photo-8022323.jpeg"
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-8542205.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  Woman Wearing Black Boater Hat
                </h5>
              </div></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-5770914.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  Man in White Long Sleeves Polo Seriously Looking
                  at the Camera
                </h5>
              </div></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-8066628.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  Alluring Woman in Black Dress
                </h5>
              </div></a>
            </div>
          </div><!-- end col -->
