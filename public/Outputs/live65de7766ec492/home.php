...
<html lang="en">
  ...
  <body>
    ...
    "background: linear-gradient(to left, #673ab7, #3e1e8c);" id=
    "home">
            ...
            <div class="row align-items-center">
              ...
              "col-xl-4 offset-xl-2 col-lg-5 offset-lg-1 col-md-7">
                <div class="home-img position-relative">
                  <img src="./storage/pexels-photo-3786132.jpeg"
                  alt="" class="home-first-img"> <img src=
                  "./storage/pexels-photo-5994862.jpeg" alt=""
                  class="home-second-img mx-auto d-block">
                  <img src="./storage/pexels-photo-3786124.jpeg"
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-8155098.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  Overhead Shot of a Dumbbell and a Clipboard
                </h5>
              </div></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-7788340.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  Closeup of magnifying glass placed near heap of
                  green pills on bright yellow surface in studio
                </h5>
              </div></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-8155165.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  Overhead Shot of Dumbbells and a Clipboard
                </h5>
              </div></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-13718764.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  Young Woman in Yellow Outfit Sitting on the Floor
          ...
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-5412330.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  Pink Pen and Scissors on the Notebook
                </h5>
              </div></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-9259982.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  Close-Up Shot of Plastic Test Tubes
                </h5>
              </div></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-11438521.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  Woman in Red Saree Standing Near the Yellow Wall
                  while Looking Afar
                </h5>
              </div></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-11438503.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
                  A Woman Wearing Traditional Standing Near Yellow
                  Wall while Smiling at the Camera
                </h5>
              </div></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="demo-box bg-white mt-4 p-2">
              <a href="#" class="text-dark"><img src=
              "./storage/pexels-photo-5469165.jpeg" alt="" class=
              "img-fluid mx-auto d-block">
              <div class="p-3 text-center">
                <h5 class="mb-0">
